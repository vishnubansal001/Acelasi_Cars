...
export default function Footer() {
  return (
    <>
    <section id='footer' className="flex flex-col md:flex-row items-start justify-between px-10 md:px-28 bg-gray-200 py-10 gap-4 text-sm">
    <div className="flex flex-col md:w-2/5 gap-4">
      <h1 className="text-sm font-semibold font-poppins">Subscribe to our newsletter</h1>
      <div className="flex flex-row px-1 py-2 border border-gray-500 bg-white border-solid rounded-full md:w-fit w-full">
        <input type="email" placeholder="Enter your email" className="rounded-l-md border-none outline-none px-2 h-8 md:w-60 w-full"/>
    ...
    <div className="flex flex-col md:w-1/5 gap-4 px-10 text-gray-500">
