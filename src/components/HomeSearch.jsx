    ...
    <div className="flex flex-row justify-center items-center w-full ">
      <div className="flex flex-row gap-2 p-4 rounded-full w-4/5 shadow-lg bg-white items-center justify-center">
        <div className="flex flex-col w-full">
          <label htmlFor="make" className="px-3">
            Make
          </label>
          <select
            name="make"
            id="make"
            className="h-10 w-full rounded-full px-2 border-2 border-gray-100 border-solid"
            onChange={(e) => {
        ...
        <div className="flex flex-col w-full">
          <label htmlFor="model" className="px-3">
            Model
          </label>
          <select
            name="model"
        ...
        <div
          href={"/search"}
          className="rounded-full bg-red-700 h-10 w-10 p-2 flex items-center justify-center"
        >
          <Search color="white" strokeWidth={1} onClick={onApplyFilters} />
        </div>
      </div>
    </div>
  );
