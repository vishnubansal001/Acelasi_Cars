...
export default function AddCar() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = axios.post("/api/cars", { ...formState, image });
  ...
  return (
    <>
      <h1 className="text-2xl font-semibold my-4 pl-6">
        Send Your{" "}
        <span className="text-red-600 font-poppins italic">Car Details</span>{" "}
        For Listing
      </h1>
